...
**Traction-friendly signals:** missing **auth scheme** (API key, OAuth, mTLS), **OpenAPI version or extension** you need, **target environment** friction (CI, cloud DB), or **operator UX** on read APIs.
